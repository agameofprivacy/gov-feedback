    ...
    render() {
        ...
        return (
            <div className="composer">
                ...
                <button id="tag-search" onClick={this.handleClick} className={"pill composer__tag" + (composerTag === "" ? " pill--unset" : " pill--highlighted")}>{composerTag === "" ? (selectedType === "org" ? "選擇議題標籤" : "選擇回饋機關") : composerTag}</button>
