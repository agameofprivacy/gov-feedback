      ...
      switch (this.props.type) {
        case "tag-search":
          this.props.setFormState({
            ...
            composerValue: this.state.composerValue,
            showsModal: false
          });
          break;
        case "identity-select":
          ...
          <div className="modal__dialog modal__dialog--small">
            <div className="modal__dialog__header">
              ...
              <h2 className="modal__dialog__header__title">
                {this.props.composerTag !== "" &&
                this.props.selectedIdentity !== "" &&
                this.state.identiyConfirmed
                  ? "檢查回饋內容"
                  : title}
              </h2>
            </div>
            <div className="modal__dialog__body">
              ...
              {type === "identity-select" && this.state.identiyConfirmed && (
                <ConfirmFeedback
                  tags={confirmFeedbackTags}
                  content={this.props.content}
                  identity={this.props.selectedIdentity}
                />
              )}
              {this.props.children}
            </div>
            <div className="modal__dialog__footer">
              ...
              {type === "identity-select" && this.state.identiyConfirmed && (
                <button
                  id="feedback-submit"
                  onClick={this.props.createPostWithComposer}
                  className="modal__dialog__footer__action modal__dialog__footer__action--primary"
                >
                  發佈回饋
                </button>
